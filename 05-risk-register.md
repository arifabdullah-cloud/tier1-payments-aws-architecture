...
| R02 | Existing application cannot be containerized without significant change | Delays adoption of the ECS/Fargate target platform | Medium | Medium | Assess runtime during discovery; retain EC2 as an exception/migration path; modernize progressively | Application Team |
